...
async function cahngeCodeDigit(i: number) {
  switch (i) {
    case 1:
      if(d1.value?.value != "") d2.value?.focus();
      break;
    case 2:
      if(d2.value?.value != "") d3.value?.focus();
      break;
    case 3:
      if(d3.value?.value != "") d4.value?.focus();
      break;
    case 4:
      if(d4.value?.value != "") d5.value?.focus();
      break;
    case 5:
      if(d5.value?.value != "") d6.value?.focus();
      break;
    case 6:
      if(d6.value?.value != "") {};
      break;
...
// selects last digit input field and updates id
async function goBack(i: number) {
  switch (i) {
    case 1:
